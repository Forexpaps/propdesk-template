...
précédente, ni à autre chose que ce dépôt. Dernier commit couvert : `6f2547c`.
...
src/
  ...
  components/          12 vues d'onglet + 10 modales
public/
  icon.png             icône 512x512 — sidebar et favicon
  logo.png             logo complet 1536x1024 — pas encore utilisé (voir §7)
...
reste utilisable — voir la limite en §6.
...
- Dépôt git initialisé, 20 commits, historique propre.
...
- **Palette unifiée** sur les 12 vues (voir §8 pour les jetons).
...
### 3. Les 9 modales n'ont pas la palette du site

L'harmonisation visuelle a couvert les 12 vues d'onglet et le centre d'alertes,
...
Pour repartir de zéro : `rm -rf data/` puis relancer.
...
### 2. Harmoniser les 9 modales restantes
...
- **Arbre de travail propre**, 20 commits, branche `main`.
...
Le point de départ naturel est la **tâche 1 du §7** — l'écran de connexion —
mais commence par lui demander les décisions listées, elles conditionnent tout
le reste.
