  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Capital Box */}
        <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl space-y-2 shadow-lg relative overflow-hidden">
        ...
        <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl space-y-2 shadow-lg">
          ...
          <div className="text-3xl font-black text-indigo-400 font-mono">{disciplineScore}%</div>
      ...
      {aiReport && (
        <div className="bg-gradient-to-r from-amber-500/10 via-slate-900 to-slate-900 border border-amber-500/30 p-6 rounded-2xl space-y-4 shadow-xl">
          ...
          <div className="text-xs sm:text-sm text-slate-200 leading-relaxed whitespace-pre-wrap border-l-2 border-amber-400 pl-4 bg-slate-950/40 p-4 rounded-xl">
            {aiReport}
          </div>
        </div>
      )}
          ...
          <div className="h-72 w-full pt-2">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={strategyChartData}>
                <CartesianGrid strokeDasharray="3 3" stroke="#1e293b" />
                <XAxis dataKey="strategy" stroke="#64748b" fontSize={10} interval={0} angle={-15} textAnchor="end" />
      ...
      <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-4 shadow-xl">
        ...
        <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 text-xs text-slate-300 flex items-start gap-3">
          ...
          <div>
            ...
            Vos positions prises avec un état <span className="text-emerald-400 font-bold">Discipliné / Calme</span> génèrent 100% de vos bénéfices nets. Les trades pris sous impulsion <span className="text-rose-400 font-bold">FOMO</span> sont responsables de la totalité de votre Drawdown.
          </div>
        </div>
      </div>
    </div>
